...
타인이 봤을 때 불쾌감을 조성하지 않는 정도로 생각하고 있습니다.`,
    ...
    {
      question: "입장은 예약인가요?",
      answer: "아직까진 예약제는 생각하고 있지 않으나 추후에 변경될 가능성이 있으니 기다려주시면 감사하겠습니다.",
    },
    {
    ...
    },
    {
      ...
      answer: `통판의 경우 현재 예정은 없으나
추후 상황에 따라 변동 가능성 있습니다.`,
    },
    {
      question: "카페에 안코하 이외의 굿즈(ex 보컬로이드 투명 포카) 등을 가져가도 될까요?",
      answer: "네 괜찮습니다.",
    },
    {
    ...
    {
      question: "타 생카 주최진이 안코하 카페 주최진에게 선물 드리면 받아 드리실까요?",
