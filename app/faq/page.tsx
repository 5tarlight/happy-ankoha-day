...
타인이 봤을 때 불쾌감을 조성하지 않는 정도로 생각하고 있습니다.`,
    ...
    },
    {
      ...
      answer: `저희 안코하 카페는 게임 규제 나이인 15세(만14세)를 고려하여 만14세 미만은 카페 이용이 어렵다고 안내하였습니다만, 
      최대한 많은 분들이 이용하시길 바라는 취지에서 세는 나이 15세(10년생) 이상의 입장을 도와드리려합니다.`,
    },
    {
      question: "혹시 드레스코드가 있을까요?",
      answer: "파란색 분홍색으로 드레스코드 이벤트가 있을 예정입니다!",
    },
    {
      question: "안녕하세요! 카페 몇시부터 몇시까지 진행하실 예정인지 여쭙고 싶습니다~!",
      answer: `토요일 11시-19시 
      일요일 11시-18시 예정이오나, 
      확정은 아니니 참고만 해주세요! 추후 정확하게 공지 올리겠습니다.`,
    },
    {
      question: "럭키드로우 인당 돌릴 수 있는 횟수는 어느정도일까요? 따로 럭키드로우 예약이 있는지도 궁금합니다..!",
      answer: `현장에서 1인당 5회까지 제한을 둘 생각이며, 
      예약은 확정이 아니지만 진행하게 될 시 인당 5회에서 10회 사이로 제한을 두고 폼을 올릴 예정입니다. 
      추후 정확하게 공지 올리겠습니다.`,
    },
  ];
